...
namespace Craft_Beer_Me.Controllers
{
    public class HomeController : Controller
    {
        ...
        public List<Brewery> LocalBrewery(double abv, double ibu, double srm, string flavor)
        {
            ...
            string SchmozPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Schmohz JSON.json";
            ...
            string JollyPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Jolly Pumpkin JSON.json";
            ...
            string AtwaterPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Atwater JSON.json";
            ...
            string NewPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\New Holland JSON.json";
            ...
            string VivantPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Brewery Vivant JSON.json";
            ...
            string ElkPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Elk Brewing JSON.json";
            ...
            string FoundersPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Founders JSON.json";
            ...
            string HarmonyPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Harmony JSON.json";
            ...
            string HideoutPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Hideout JSON.json";
            ...
            string PeoplesPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Peoples Cider JSON.json";
            ...
            string PerrinPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Perrin JSON.json";
            ...
            string RockPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\Rockford Brewing JSON.json";
            ...
            string MittenPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\The Mitten JSON.json";
            ...
            string HopcatPath = @"C:\Users\mfilice\source\repos\Cure for the Common Brew\Cure-for-the-Common-Brew\Craft Beer Me\Controllers\hopcat json.json";
